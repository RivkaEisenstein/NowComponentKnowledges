...
const requestSearchResults = ({ properties, dispatch }) => {
	if (properties.searchText) {
        console.log("searchtext: "+properties.searchText);
...
createCustomElement("x-849479--kb-search-results", {
	...
	actionHandlers: {
		...
		SEARCH_RESULTS_REQUESTED: createHttpEffect("/api/now/table/kb_knowledge", {
            method: 'GET',
